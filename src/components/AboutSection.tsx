    ...
    <FadeUpSection id="about" className="min-h-screen flex items-center py-24 md:py-32">
      <div className="w-[90%] max-w-6xl mx-auto">
        ...
        <div className="space-y-6 text-base md:text-lg text-white/75 leading-relaxed max-w-4xl">
          ...
          <p>
            AIによって「作るスピード」は劇的に上がりました。その結果、ボトルネックは「どう作るか」から「何を作るべきか」へ移っています。顧客の現場に入り、本当の課題を見極め、その場で作って動かせるFDEの価値は、PalantirやSierra、Harveyといった海外企業の急成長とともに証明されつつあります。
          </p>
          <p>
            FDEは、単なる受託開発ではありません。現場に深く入り込むから、汎用のSaaSよりも業務に刺さる。そこで得た知見を仕組みとして還元するから、受託よりも速く成果が積み上がる。SaaSとコンサルの間にある、新しい支援のかたちです。
          </p>
          <p>
