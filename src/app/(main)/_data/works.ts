...
export const works: Work[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "フード・フィルム・シアター・ミュージックの4つのフェスを通じて、子どもたちや単身世帯の方々が「おなかいっぱい、こころいっぱい」になれる時間を届けます。たった一度の「美味しかった」「楽しかった」が人生を変えるきっかけになる——nodeはこのイベントに参画し、その想いが伝わり参加と協賛の輪が広がるWeb体験づくりを担っています。",
    ],
